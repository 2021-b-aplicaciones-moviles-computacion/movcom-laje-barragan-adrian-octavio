...
class Especie : AppCompatActivity() {
    ...
    var resultLauncher = registerForActivityResult(
        ...
        if (result.resultCode == Activity.RESULT_OK) {
            if(result.data != null){
                ...
                val nuevoNombreEspecie = data?.getStringExtra("nuevaNombreEspecie").toString()
                val nuevoPielEspecie = data?.getStringExtra("nuevaPielEspecie").toString()
                val nuevoAmamantanEspecie = data?.getStringExtra("nuevaAmamantanEspecie").toBoolean()
                val nuevoPesoEspecie = data?.getStringExtra("nuevaPesoEspecie").toString().toDouble()
                val nuevoNumeroEspecie = data?.getStringExtra("nuevaNumeroEspecie").toString().toInt()
                BBaseDatosMemoria.arregloBEspecie.add(BEspecie(nuevoNombreEspecie, nuevoPielEspecie,nuevoAmamantanEspecie, nuevoPesoEspecie, nuevoNumeroEspecie))
